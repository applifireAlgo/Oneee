Ext.define("Twotest.view.clouddrive.CloudDrive", {
	extend : 'Ext.panel.Panel',
	xtype : 'clouddrive',
	requires : [ 'Twotest.view.clouddrive.CloudDriveController',
	             'Twotest.view.clouddrive.documentview.DocumentsView',
	             'Twotest.view.clouddrive.drivedetails.DriveDetails',
	             //'Twotest.view.clouddrive.documentview.DocumentListView'
	             ],
