 ...
 * 
 */
Ext.define('Twotest.view.logalarm.mainscreen.AddLogAlarm', {
	extend : 'Ext.form.Panel',
	xtype : 'addLogAlarm',
	requires : [ 'Twotest.view.logalarm.mainscreen.AddLogAlarmController',
			'Twotest.view.logalarm.mainscreen.AppAlarmGridPanel',
			'Twotest.view.logalarm.mainscreen.AppAlarmPanel',
