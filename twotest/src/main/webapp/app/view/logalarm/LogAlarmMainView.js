 ...
 * 
 */
Ext.define('Twotest.view.logalarm.LogAlarmMainView', {
	extend : 'Ext.form.Panel',
	xtype : 'logAlarmMainView',
	requires : [ 'Twotest.view.logalarm.LogAlarmMainViewController',
			'Twotest.view.logalarm.tree.LogAlarmTreePanel',
			'Twotest.view.logalarm.mainscreen.LogAlarmMainViewTabPanel',
