 ...
 * 
 */
Ext.define('Twotest.view.logger.tabs.syslogsocketconnector.SyslogSocketConnectorTab', {
	...
	requires : ['Twotest.view.logger.tabs.syslogsocketconnector.SyslogSocketConnectorTabController'],
