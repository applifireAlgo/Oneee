Ext.define('Twotest.view.reportui.datachart.chart.ChartTabView', {
	extend : 'Ext.panel.Panel',
	requires:['Twotest.view.reportui.datachart.chart.RatingField','Twotest.view.reportui.datachart.chart.ChartController'],
	xtype : 'chart-tabView',
