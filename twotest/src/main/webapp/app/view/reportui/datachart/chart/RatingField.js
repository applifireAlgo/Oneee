...
Ext.define('Twotest.view.reportui.datachart.chart.RatingField', {
	...
	onRender: function(ct, position) {
		Twotest.view.reportui.datachart.chart.RatingField.superclass.onRender.call(this, ct, position);
	 ...
	 */
	initEvents: function() {
		Twotest.view.reportui.datachart.chart.RatingField.superclass.initEvents.call(this);
