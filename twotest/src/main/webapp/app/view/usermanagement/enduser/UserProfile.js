Ext.define('Twotest.view.usermanagement.enduser.UserProfile', {
	extend : 'Ext.form.Panel',
	xtype : 'userProfileView',
	requires : [ 'Twotest.view.usermanagement.enduser.UserProfileController', 'Twotest.view.usermanagement.admin.AddUserDetailsViewModel', 'Twotest.model.AddUserDataModel' ],
