Ext
		.define(
				'Twotest.view.searchengine.search.ResultPanel',
				{
					extend : 'Ext.panel.Panel',
					xtype : 'resultPanel',
					itemId : "resultsTab",
					plugins : 'responsive',
					requires : [ 'Twotest.view.searchengine.search.SearchEngineMainPanelController','Twotest.view.searchengine.search.PanelHeaderField' ,'Twotest.view.searchengine.search.ReportGridView','Twotest.view.searchengine.search.ReportChartView','Twotest.view.searchengine.search.documentView','Twotest.view.searchengine.search.DouMeanView','Twotest.view.googlemaps.map.MapPanel'],
