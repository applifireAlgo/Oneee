Ext.define('Twotest.view.searchengine.search.SearchEngineMainPanel', {
	extend : 'Ext.panel.Panel',
	xtype : 'solrsearchmainpanel',
	

	requires : ['Twotest.view.searchengine.search.NorthPanel', 'Twotest.view.searchengine.search.SearchResult','Twotest.view.searchengine.search.SearchEngineMainPanelController'],
