 ...
 * 
 */
Ext.define('Twotest.view.securityconfig.SecurityConfig', {
	extend : 'Ext.form.Panel',
	xtype : 'securityConfig',
	requires : [ 'Twotest.view.securityconfig.SecurityConfigController',
			'Twotest.view.securityconfig.SecurityQuestion', 'Ext.form.FieldSet',
