 ...
 */
Ext.define('Twotest.view.fw.component.DateTimeField', {
    extend: 'Ext.form.field.Date',
    alias: 'widget.customdatetimefield',
    xtype : 'customdatetimefield',
    requires: ['Twotest.view.fw.component.DateTimePicker'
               ],
    ...
    createPicker: function() {
        ...
        return new Twotest.view.fw.component.DateTimePicker(o);
    },
