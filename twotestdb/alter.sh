...
ART_CREATE_PATH=/tmp/applifire/db/S0JSME5B7DBZ4COVKBEI9Q/D7EFF9DA-2CEA-4032-A634-1C9EE42862FC/art/create
AST_CREATE_PATH=/tmp/applifire/db/S0JSME5B7DBZ4COVKBEI9Q/D7EFF9DA-2CEA-4032-A634-1C9EE42862FC/ast/create
MYSQL=/usr/bin
APPLFIREUSER=root
...
$MYSQL/mysql --local-infile=1 -h$HOST -p$PORT -u$USER -p$PASSWORD $DB_NAME -e "SOURCE $AST_CREATE_PATH/alter_ast_AA_M.sql"; 

$MYSQL/mysql --local-infile=1 -h$HOST -p$PORT -u$USER -p$PASSWORD $DB_NAME -e "SOURCE $AST_CREATE_PATH/alter_ast_Fdfd_M.sql"; 
